  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1.5">
        <Link
          className="rounded-control px-2.5 py-1.5 text-sm text-muted-bright transition-colors hover:bg-surface-raised hover:text-accent-text"
          activeOptions={{ exact: false }}
          activeProps={{
            className:
              'rounded-control bg-surface-raised px-2.5 py-1.5 text-sm text-foreground',
          }}
          to="/docs"
        >
          Docs
...
export function SiteFooter() {
  return (
    <footer className="flex flex-col gap-4 border-t border-line px-1 pt-6 text-xs leading-relaxed text-muted-foreground md:flex-row md:items-center md:justify-between">
      <nav
