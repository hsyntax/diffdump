    ...
    <TooltipPrimitive.Portal>
      ...
      >
        <TooltipPrimitive.Popup
          ...
          className={cn(
            'max-w-64 origin-[var(--transform-origin)] rounded-control border border-line-bright bg-popover px-2 py-1 text-2xs font-medium text-popover-foreground shadow-float',
