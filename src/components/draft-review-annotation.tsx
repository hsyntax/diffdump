  ...
  return (
    <Tooltip>
      <TooltipTrigger
        render={
          <span
            className="inline-flex shrink-0 cursor-help items-center rounded border border-line bg-surface px-1.5 py-0.5 text-2xs font-medium text-deletion"
  ...
  return (
    <div className={cardClassName} data-testid="draft-review-annotation">
      <div className="flex items-center gap-2">
        <span className="inline-flex items-center rounded border border-line bg-surface px-1.5 py-0.5 text-2xs font-medium text-accent-text">
          Pending
        </span>
